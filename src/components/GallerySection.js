            ...
            <section className="pb_section" id="section-gallery">
                <div className="container">
                    ...
                    <div className="col-md-10 text-center">
                        ...
                        <button role="button" onClick={() => {window.open('https://www.instagram.com/rosiesmia/', '_blank')}} className="btn btn-ins btn-outline-primary" style={{cursor: 'pointer'}}><i className="fab fa-instagram pr-1"></i> Instagram</button>
                    </div>
                    </div>
                    <div className="row">
                    <div className="col">
