                ...
                <section className="pb_section bg-light" id="section-team">
                    ...
                    <div className="row">
                        ...
                        <div className="card border-0">
                            ...
                            <p className="card-text">
                                The initial intent of Copper Door Properties was to establish vacation rental properties in under-developed areas in order to promote cultural tourism and more local perspective when it comes to what Miami can offer its tourists. The Copper Door Properties portfolio currently include The Copper Door B&amp;B and Rosie’s Pop-Up. For press and interviews, click <a href="https://www.copperdoorbnb.com/press" target="_blank">here</a>!
                            </p>
                            </div>
                        </div>
                        </div>
